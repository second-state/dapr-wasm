...
if [ ! -f "$FILE" ]; then
    echo "install $FILE ..."
    curl -L https://github.com/second-state/WasmEdge-tensorflow-tools/releases/download/0.8.2/WasmEdge-tensorflow-tools-0.8.2-manylinux2014_x86_64.tar.gz -o ./WasmEdge-tensorflow-tools-0.8.2-manylinux2014_x86_64.tar.gz
    tar xzvf WasmEdge-tensorflow-tools-0.8.2-manylinux2014_x86_64.tar.gz wasmedge-tensorflow-lite
    tar xzvf WasmEdge-tensorflow-tools-0.8.2-manylinux2014_x86_64.tar.gz wasmedgec-tensorflow
    rm WasmEdge-tensorflow-tools-0.8.2-manylinux2014_x86_64.tar.gz
